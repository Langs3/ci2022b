                    ...
                    <div class="list-group-item p-3">
                        <div class="row align-items-start">
                            ...
                            <div class="col mb-8pt mb-md-0">
                                <input name="title" type="text" class="form-control" placeholder="Judul Berita" value="<?= set_value('title') ?: $news->title; ?>" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="list-group-item p-3">
                        <div class="row align-items-start">
                            <div class="col-md-4 mb-8pt mb-md-0">
                                <div class="media align-items-left">
                                    <div class="d-flex flex-column media-body media-middle">
                                        <span class="card-title">Tanggal Terbit</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col mb-8pt mb-md-0">
                    ...
                    <div class="list-group-item p-3">
                        <div class="row align-items-start">
                            <div class="col-md-4 mb-8pt mb-md-0">
                                <div class="media align-items-left">
                                    <div class="d-flex flex-column media-body media-middle">
                                        <span class="card-title">Gambar</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col mb-8pt mb-md-0">
                    ...
                    <div class="list-group-item p-3">
                        <div class="row align-items-start">
                            <div class="col-md-4 mb-8pt mb-md-0">
                                <div class="media align-items-left">
                                    <div class="d-flex flex-column media-body media-middle">
                                        <span class="card-title">Isi Berita</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col mb-8pt mb-md-0">
